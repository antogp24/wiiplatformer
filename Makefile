...
# includes /opt/devkitpro/devkitPPC/wii_rules
# includes /opt/devkitpro/devkitPPC/base_rules
# includes /opt/devkitpro/devkitPPC/base_tools
...
#---------------------------------------------------------------------------------
LIBS := -ldb -lgrrlib -lpngu `$(PREFIX)pkg-config freetype2 libpng libjpeg --libs` -lfat
LIBS += -lwiiuse
